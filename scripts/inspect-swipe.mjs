...
try {
  ...
  await page.screenshot({ path: 'docs/images/swipe-01-rightswipe.png' });

  // Probe what's on top at multiple X positions.
  ...
  console.log('top element at each x (mid swipe, viewport y≈mid-cols):');
